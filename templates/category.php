    ...
    <div class="container">
        ...
        <?php if ($pages_count > 1): ?>
            <ul class="pagination-list">
                <li class="pagination-item pagination-item-prev"><a <?php if ($cur_page != 1): ?>href="category.php?id=<?= $category_id; ?>&page=<?= $cur_page-1; ?>"<?php endif; ?>>Назад</a></li>
                ...
                <?php endforeach; ?>
                <li class="pagination-item pagination-item-next"><a <?php if ($cur_page != $pages_count): ?>href="category.php?id=<?= $category_id; ?>&page=<?= $cur_page+1; ?>"<?php endif; ?>>Вперед</a></li>
            </ul>
        <?php endif; ?>
    </div>
</main>
